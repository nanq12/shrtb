...
if ($slug) {
    ...
    if ($link = $result->fetch_assoc()) {
        ...
        <head>
          ...
          <style>
            ...
            @media (max-width: 600px) {
              ...
              .watch-btn { font-size: 16px; padding: 10px 25px; }
            }
            @keyframes fadeIn {
        ...
        <body>
          <div class='container'>
            <h1>$title</h1>
            <img src='$image_url' class='video-thumbnail' alt='Video Thumbnail'>
            <p>$meta_description</p>
            <a href='$original_url' class='watch-btn'>Tonton Video</a>
          </div>
        </body>
        </html>";
    } else {
